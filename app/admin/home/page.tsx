  ...
  return (
    <div className="min-h-screen bg-[#23272f] flex flex-col">
      ...
      <main className="flex-1 p-8">
        ...
        {message && (
          <div className="mb-4 text-sm text-[#bfc7d5]">{message}</div>
        )}
                  ...
                  {afiliados.map((item) => (
                    ...
                    >
                      <input
                        ...
                        checked={
                          item.id
                            ? selectedAfiliadoIds.includes(String(item.id))
                            : false
                        }
                        onChange={() =>
                          toggleAfiliado(item.id ? String(item.id) : undefined)
                        }
                      />
                      <div>
                        <div className="font-semibold text-sm text-white">
