        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-gradient-to-br from-indigo-600 to-sky-500 rounded-lg flex items-center justify-center text-white font-bold text-lg">
                F
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <FooterLink href="/categoria/comparativos">Comparativos</FooterLink>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm mb-4">
              Receba as melhores notícias de tecnologia diretamente no seu e-mail.
            </p>
...
function SocialLink({ href, icon }: { href: string; icon: React.ReactNode }) {
  return (
    <a
      href={href}
      className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 text-slate-600 hover:bg-indigo-600 hover:text-white transition-all duration-300"
    >
      {icon}
    </a>
  );
